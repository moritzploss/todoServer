defmodule Todo.EntryTest do
  ...
  test "update entry description" do
    entry = Entry.new("Write a failing test!")
    new_description = "Then make it pass!"
    new_entry = Entry.update(entry, :description, new_description)
  ...
  test "update entry status" do
    entry = Entry.new("Write a passing test!")
    closed_entry = Entry.update(entry, :status, :closed)
