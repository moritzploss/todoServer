defmodule TodoInterfaceWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule TodoInterface.MyChannel do
  ...
  """
  use Phoenix.Presence, otp_app: :todo_interface,
                        pubsub_server: TodoInterface.PubSub
end
